...
// product all
$query = mysqli_query($conn, "SELECT * FROM products WHERE product_type = 'console'");
  ...
  <div class="container mt-5"><br>
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination justify-content-center">
        ...
        <li class="page-item"><a class="page-link" href="../Product/product_list.php max(1, $page - 1); ?>">Previous</a>
        </li>
        <?php for ($i = 1; $i <= $total_page; $i++) { ?>
        <li class="page-item"><a class="page-link" href="../Product/product_list.php?page=<?= $i ?>"><?= $i ?></a></li>
        <?php } ?>
        <?php if ($page < $total_page) { ?>
        <li class="page-item"><a class="page-link" href="../Product/product_list.php?page=<?=$total_page?>">Next</a>
        </li>
        <?php } ?>
      </ul>
    </nav>
