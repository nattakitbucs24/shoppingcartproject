                            ...
                            <?php if($rows > 0): ?>
                                <?php while($product = mysqli_fetch_assoc($query)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="return confirm('Are you sure want to delete?');" role="button" href="<?php echo $base_url; ?>/cart-delete.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-delete-left"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                                <tr>
                                    <td colspan="6" class="text-end">
                                        ...
                                        <a href="<?php echo $base_url;?>/checkout.php" type="submit" class="btn btn-lg btn-primary">เช็คบิล</a>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <tr>
